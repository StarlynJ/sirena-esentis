...
import { ClipboardList, Heart, MapPin, Menu, Search, ShoppingCart, UserRound, X } from "lucide-react";
  ...
  return (
    <header className="site-header">
      <div className="header-main">
        <HardLink className="official-logo" href="/" aria-label="Sirena inicio"><img src="/brand/sirena-logo.webp" alt="Sirena" /></HardLink>
        ...
        <div className="header-actions">
          ...
          <HardLink className="header-action cart-action" href="/carrito">
      ...
      <nav className="desktop-nav" aria-label="Navegación principal">
        ...
        {navItems.map((item) => <HardLink href={`/?categoria=${encodeURIComponent(item)}`} key={item}>{item}</HardLink>)}
      </nav>
      {addressOpen && (
